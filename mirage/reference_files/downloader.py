...
NIRCAM_CR_LIBRARY_URL = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/nircam/cosmic_ray_library/mirage_nircam_cr_library.tar.gz"
]
NIRISS_CR_LIBRARY_URL = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/niriss/cosmic_ray_library/mirage_niriss_cr_library.tar.gz"
]
FGS_CR_LIBRARY_URL = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/fgs/cosmic_ray_library/mirage_fgs_cr_library.tar.gz"
]

# Gridded PSF libraries
NIRCAM_GRIDDED_PSF_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/nircam/psf_libraries/gridded_psf_libraries/nircam_psf_wings_library.tar.gz",
...
NIRISS_GRIDDED_PSF_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/niriss/psf_libraries/gridded_psf_libraries/niriss_gridded_psf_library.tar.gz"
]
FGS_GRIDDED_PSF_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/fgs/psf_libraries/gridded_psf_libraries/fgs_gridded_psf_library.tar.gz"
]

# Dark current files
NIRCAM_RAW_DARK_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/nircam/darks/raw/A1/NRCNRCA1-DARK-60082202011_1_481_SE_2016-01-09T00h03m58_level1b_uncal.fits.gz",
...
NIRCAM_LINEARIZED_DARK_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/nircam/darks/linearized/A1/Linearized_Dark_and_SBRefpix_NRCNRCA1-DARK-60082202011_1_481_SE_2016-01-09T00h03m58_uncal.fits.gz",
...
NIRISS_RAW_DARK_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/niriss/darks/raw/NISNIRISSDARK-153451235_11_496_SE_2015-12-11T16h05m20_dms_uncal.fits.gz",
...
NIRISS_LINEARIZED_DARK_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/niriss/darks/linearized/Linearized_Dark_and_SBRefpix_NISNIRISSDARK-153451235_11_496_SE_2015-12-11T16h05m20_dms_uncal_linear_dark_prep_object.fits.gz",
...
FGS_RAW_DARK_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/fgs/darks/raw/29722_1x88_FGSF03512-D-NR-G2-5339214947_1_498_SE_2015-12-05T22h27m19_dms_uncal.fits.gz",
...
FGS_LINEARIZED_DARK_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/fgs/darks/linearized/29722_1x88_FGSF03512-D-NR-G2-5339214947_1_498_SE_2015-12-05T22h27m19_dms_uncal_linearized.fits.gz",
...
NIRISS_PSF_GHOST_STAMP = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/niriss/ghosts/niriss_ghost_stamps.tar.gz"
]

NIRISS_SOSS_URLS = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/niriss/soss/niriss_soss_psfs.tar.gz"
]

TEMP_DISTORTION_REFERENCE_FILES = [
    "https://data.science.stsci.edu/redirect/JWST/jwst-simulations/mirage_reference_files/nircam/reference_files/nircam_distortion_files.tar.gz"
]

DISK_USAGE = {
    "nircam": {"crs": 1.1, "psfs": 23, "raw_darks": 79, "lin_darks": 319},
    "niriss": {
        "crs": 0.26,
        "psfs": 0.87,
        "raw_darks": 31,
    ...
    "fgs": {"crs": 0.31, "psfs": 0.04, "raw_darks": 11, "lin_darks": 39},
}
...
def download_reffiles(
    ...
    print(
        (
            "Mirage reference files downloaded and extracted. \nBefore "
    ...
    for instrument_name in instrument_names:
        ...
        if instrument_name.lower() == "nircam":
            ...
            if not skip_cosmic_rays:
                ...
                print(
                    "Size of NIRCam cosmic ray library file: {} Gb".format(added_size)
                )
            ...
            if not skip_darks:
                if not single_dark:
                    if dark_current in ["linearized", "both"]:
                        ...
                        total_download_size += added_size
                        print(
                            "Size of NIRCam linearized dark files: {} Gb".format(
                                added_size
                            )
                        )
                    ...
                    if dark_current in ["linearized", "both"]:
                        one_dark_per_detector = single_dark_per_det(
                            NIRCAM_LINEARIZED_DARK_URLS
                        )
                        urls.extend(one_dark_per_detector)
                        added_size = (
                            DISK_USAGE["nircam"]["lin_darks"]
                            / len(NIRCAM_LINEARIZED_DARK_URLS)
                            * 10.0
                        )
                        total_download_size += added_size
                        print(
                            "Size of NIRCam linearized dark files (one dark per detector): {} Gb".format(
                                added_size
                            )
                        )
                    if dark_current in ["raw", "both"]:
                        ...
                        urls.extend(one_dark_per_detector)
                        added_size = (
                            DISK_USAGE["nircam"]["raw_darks"]
                            / len(NIRCAM_RAW_DARK_URLS)
                            * 10.0
                        )
                        total_download_size += added_size
                        print(
                            "Size of NIRCam raw dark files (one dark per detector): {} Gb".format(
                                added_size
                            )
                        )
        ...
        # NIRISS
            ...
            if not skip_cosmic_rays:
                ...
                total_download_size += added_size
                print(
                    "Size of NIRISS cosmic ray library file: {} Gb".format(added_size)
                )
            ...
            if not skip_darks:
                if not single_dark:
                    if dark_current in ["linearized", "both"]:
                        ...
                        total_download_size += added_size
                        print(
                            "Size of NIRISS linearized dark files: {} Gb".format(
                                added_size
                            )
                        )
                    if dark_current in ["raw", "both"]:
                    ...
                    if dark_current in ["linearized", "both"]:
                        ...
                        added_size = DISK_USAGE["niriss"]["lin_darks"] / len(
                            NIRISS_LINEARIZED_DARK_URLS
                        )
                        total_download_size += added_size
                        print(
                            "Size of NIRISS linearized dark file: {} Gb".format(
                                added_size
                            )
                        )
                    if dark_current in ["raw", "both"]:
                        urls.extend([NIRISS_RAW_DARK_URLS[0]])
                        added_size = DISK_USAGE["niriss"]["raw_darks"] / len(
                            NIRISS_RAW_DARK_URLS
                        )
                        total_download_size += added_size
            ...
            if not skip_darks:
                if not single_dark:
                    if dark_current in ["linearized", "both"]:
                        ...
                        total_download_size += added_size
                        print(
                            "Size of FGS linearized dark files: {} Gb".format(
                                added_size
                            )
                        )
                    if dark_current in ["raw", "both"]:
                    ...
                    if dark_current in ["linearized", "both"]:
                        ...
                        added_size = DISK_USAGE["fgs"]["lin_darks"] / len(
                            FGS_LINEARIZED_DARK_URLS
                        )
                        total_download_size += added_size
                        print(
                            "Size of FGS linearized dark file: {} Gb".format(added_size)
                        )
                    if dark_current in ["raw", "both"]:
                        urls.extend([FGS_RAW_DARK_URLS[0]])
                        added_size = DISK_USAGE["fgs"]["raw_darks"] / len(
                            FGS_RAW_DARK_URLS
                        )
                        total_download_size += added_size
