...
def move_logfile_to_standard_location(
    base_file, input_log_file, yaml_outdir=None, log_type="catalog_seed"
):
    ...
    final_logfile_name = create_standard_logfile_name(
        os.path.basename(base_file), log_type=log_type
    )
